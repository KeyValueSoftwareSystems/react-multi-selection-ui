...
const SearchComponent = (props: SearchComponentPropType, ref: ForwardedRef<HTMLInputElement>):JSX.Element => {
  const {
    onSearch,
    searchPlaceholder,
    styles = {},
  ...
  return (
    ...
    >
      <img src={icon || searchIcon} alt=''  className={classes.chipClose} style={getStyles(Elements.SearchIcon, styles)} />
      <input
        type="text"
