...
WithOptionalProps.args = {
  ...
  styles: {
    ...
    SelectedMenuItem:() =>({ fontSize: 18, color: '#000000', backgroundColor: '#D9E2F0' }),
    UnSelectedMenuItem:() =>({ fontSize: 18, color: '#000000', backgroundColor: '#FFFFFF' }),
  ...
  hasError: false,
  icons:{
    Search: 'https://static-00.iconduck.com/assets.00/search-icon-2048x2048-zik280t3.png',
  },
};
...
WithError.args = {
  ...
  onSearch: undefined,
  helperText: "This is a dummy error text",
  hasError: true,
  styles: {
